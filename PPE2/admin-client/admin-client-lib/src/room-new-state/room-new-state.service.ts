...
import { IRoomNewNavAccess, IRoomNewGateway, IRoomNewController, IRoomNewAuthAccess } from '.';
...
export class RoomNewService {
  ...
  private _auth: IRoomNewAuthAccess;

  constructor(config: {
    navigation: IRoomNewNavAccess,
    gateway: IRoomNewGateway,
    authentification: IRoomNewAuthAccess
  }) {
